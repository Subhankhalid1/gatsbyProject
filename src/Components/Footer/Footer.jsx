...
const Footer = () => {
    ...
    return <>
        <footer className="body-font footer" style={{ backgroundColor: "#fafafa" }} >
            <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                <div className="flex-grow flex flex-wrap footer-container-flex">
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4 footer-container">
                        <h2 className="title-font-1 font-medium text-gray-900 tracking-widest text-sm mb-3 heading-links">ABOUT US</h2>
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4 footer-container">
                        <h2 className="title-font-1 font-medium text-gray-900 tracking-widest text-sm mb-3 heading-links">HELP</h2>
                        <nav className="list-none mb-10">
                            <li>
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4 footer-container">
                        <h2 className="title-font-1 font-medium text-gray-900 tracking-widest text-sm mb-3 heading-links">CONTACT US</h2>
                        <nav className="list-none mb-10">
                            <li>
                                <a className="text-gray-600 hover:text-gray-800 about-link">MIRACULEAN</a>
                            </li>
                            <li>
                                <a className="text-gray-600 hover:text-gray-800 about-link light">Barangay Hiwacloy, Goa 4422,<br />Camarines Sur, Phillippines <br /> Registerd No: 05516419</a>
                            </li>
                            <li><br />
                                <a className="text-gray-600 hover:text-gray-800 about-link">EMAIL</a>
                            </li>
                            <li>
                                <a className="text-gray-600 hover:text-gray-800 about-link light">info@richberry.ph</a>
                            </li>
                            <li><br />
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4 footer-container">
                        <h2 className="title-font-1 font-medium text-gray-900 tracking-widest text-sm mb-3 heading-links">NEWSLETTER</h2>
                        <div style={{ textAlign: "justify" }}>
                            <p className="mt-2 text-sm text-gray-800 light p-color">Grab our latest no sugar added recipes, promotions and exclusive deals right to your inbox</p>
                        </div>
                        <br />
                        <div style={{ textAlign: "justify" }}>
                            <input className="input-email" placeholder="Enter Email" />
                            <p className="mt-2 text-sm text-black-800 light p-color">By subscribing, you agree with the privacy policy</p>
                        </div>
                        <br />
                        <div>
                            <h6 className="heading-links">FOLLOW US</h6>
                            <div className="container follow-div py-4">
            ...
            <div className="bg-gray-100">
                <div className="container footer-end mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    <p className="text-gray-500 footer-text text-sm text-center sm:text-left">All rights reserved ©richberry.ph</p>
                </div>
            </div>
        </footer>
    </>
