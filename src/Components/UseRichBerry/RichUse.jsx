...
const RichUse = () => {
    ...
    return (
        <section class="text-gray-600 body-font">
            <h1 data-sal="slide-up" data-sal-delay="1000" data-sal-easing="ease-out-back" className="text-center mt-14 text-2xl font-bold text-black">HOW TO USE RICHBERRY</h1>
            <div class=" py-24 mx-auto">
                {/* 1 */}
                <div class="flex items-center  lg:w-4/5 mx-auto pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
                    <div data-sal="slide-left"  data-sal-easing="ease-out-back" style={{border: 'none'}} class="sm:w-32 img-use img-use sm:h-32 h-20 w-20 sm:mr-10 inline-flex items-center justify-center rounded-full text-indigo-500 flex-shrink-0">

                        <img className="w-full h-full object-fill" className="w-full h-full object-fill" src="/images/first.jpg" alt="First slide" />
                    </div>
                ...
                <h1 data-sal="slide-down" data-sal-delay="1000" data-sal-easing="ease-out-back" style={{ color: "black", fontSize: "60px", marginRight: '5%' }}><strong style={{ fontSize: "10rem" }}>2</strong></h1>
                    ...
                    <div data-sal="slide-left"  data-sal-easing="ease-out-back" style={{border: 'none'}} class="sm:w-32 img-use img-use sm:h-32 h-20 w-20 sm:mr-10 inline-flex items-center justify-center rounded-full text-indigo-500 flex-shrink-0">
                        ...
                        <img className="w-full h-full object-fill" className="w-full h-full object-fill" src="/images/second.jpg" alt="First slide" />
                    </div>
                ...
                <div class="flex items-center  lg:w-4/5 mx-auto pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
                    <div data-sal="slide-left"  data-sal-easing="ease-out-back" style={{border: 'none'}} class="sm:w-32 img-use img-use sm:h-32 h-20 w-20 sm:mr-10 inline-flex items-center justify-center rounded-full text-indigo-500 flex-shrink-0">
                        ...
                        <img className="w-full h-full object-fill" className="w-full h-full object-fill" src="/images/third.jpg" alt="First slide" />
                    </div>
                ...
                <h1  data-sal="slide-down" data-sal-delay="1000" data-sal-easing="ease-out-back" style={{ color: "black", fontSize: "60px", marginRight: '5%' }}><strong style={{ fontSize: "10rem" }}>4</strong></h1>
                    ...
                    <div data-sal="slide-left"  data-sal-easing="ease-out-back" style={{border: 'none'}} class="sm:w-32 img-use img-use sm:h-32 h-20 w-20 sm:mr-10 inline-flex items-center justify-center rounded-full text-indigo-500 flex-shrink-0">
                        ...
                        <img className="w-full h-full object-fill" className="w-full h-full object-fill" src="/images/forth.jpg" alt="First slide" />
                    </div>
